...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        protected void compute() {
            if (endIndexExclusive - startIndexInclusive < SPLIT_THRESHOLD)
            {
                value = 0;
                ...
                ReciprocalArraySumTask l = new ReciprocalArraySumTask(startIndexInclusive, midPoint, input);
                ReciprocalArraySumTask r = new ReciprocalArraySumTask(midPoint, endIndexExclusive, input);
                l.fork();
                r.compute();
                l.join();
